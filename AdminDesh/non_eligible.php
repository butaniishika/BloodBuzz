...
.input-group-lg> .input-group-lg>.form-control, .input-group-lg>.form-select, .input-group-lg>.input-group-text {
    padding: 0.5rem 1rem;
    font-size: 1.25rem;
...
<body>
    ...
    <div class="container">
        ...
        <h2>Non Eligible Report</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="Neligible.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="non_eligib.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result = $connection->query("SELECT m.name,m.gender,m.email,d.donation_status,d.member_id FROM donors d JOIN members m ON m.member_id=d.member_id WHERE d.donation_status= '0'");
