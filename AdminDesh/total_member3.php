...
<body>
    ...
    <h2>Total Member record</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="total_member4.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="total_member2.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered table-hover">
                ...
                $total_records_query = "SELECT COUNT(*) AS total FROM members WHERE member_status='1'";
                ...
                $result=$connection->query("SELECT c.city_name , s.state_name , m.* FROM members m JOIN city c ON c.city_id = m.city JOIN states s ON s.state_id = m.state WHERE member_status='1' LIMIT $offset, $records_per_page");
