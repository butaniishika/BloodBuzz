...
<body>
    ...
    <div class="container">
        ...
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="delete_profile4.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="delete_profile2.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT m.*,c.city_name,s.state_name FROM  members m JOIN city c ON c.city_id = m.city JOIN states s ON s.state_id = m.state WHERE member_status='0'");
