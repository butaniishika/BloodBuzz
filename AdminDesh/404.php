...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="content">
            ...
            <!-- 404 Start -->
            <div class="container-fluid pt-4 px-4" style="margin-left:-100px;">
                <div class="row vh-100 bg-light rounded align-items-center justify-content-center mx-0">
                    <div class="col-md-6 text-center p-4">
                        <i class="bi bi-exclamation-triangle display-1 text-primary"></i>
                        <h1 class="display-1 fw-bold">404</h1>
                        <h1 class="mb-4">Page Not Found</h1>
                        <p class="mb-4">We're sorry, the page you have looked is not accessible without login.You need to login first !</p>
                            <p class="countdown" style="font-size:20px;">Redirecting To Login Page In <span id="countdown">5</span> Seconds</p>
                        <a class="btn btn-primary rounded-pill py-3 px-5" href="./index.php">Go Back To Login</a>
                    </div>
                </div>
            </div>
            <!-- 404 End -->
