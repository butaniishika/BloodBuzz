...
<body>
    ...
    <div class="container">
        ...
        <h2>Current Day Request</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="cur_day_request.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="cur_day_reque.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT m.name, r.*,b.blood_grp  FROM requester r  JOIN members m ON r.member_id = m.member_id JOIN blood_group b ON b.blood_id=r.blood_id
