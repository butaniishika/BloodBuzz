...
<body>
    ...
    <div class="container">
        ...
        <h2>New Users From Last Month Report</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="newUser.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="new_user_last_mon.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT c.city_name , s.state_name , m.* FROM members m JOIN city c ON c.city_id = m.city JOIN states s ON s.state_id = m.state WHERE MONTH(m.created_at) = MONTH(CURRENT_DATE) - 1 AND YEAR(m.created_at) = YEAR(CURRENT_DATE) ");
