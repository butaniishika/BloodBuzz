...
<head>
    <meta charset="utf-8">
    <title>Blood Buzz-Manage Donor</title>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="manageDonor.php" class="dropdown-item active">Donor</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                try
                {
                $get_donors=$connection->prepare("SELECT m.name,m.email,d.* FROM donors d LEFT JOIN members m ON m.member_id = d.member_id WHERE donation_status IN ('1','0') LIMIT $offset,$records_per_page");
                $get_donors->execute();
                ...
                $total_records = $connection->query("SELECT COUNT(*) FROM donors WHERE donation_status IN ('1','0')")->fetchColumn();
                ...
                ?></td>
                <td>
                <?php $encryptedDid=base64_encode($row['donor_id']); ?> 
              <form action="deleteDonor.php?did=<?php echo $encryptedDid; ?>" method="post">
