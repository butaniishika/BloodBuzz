...
<body>
    ...
    <div class="container">
        ...
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="camp_status4.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="camp_status2.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT * ,m.name, s.state_name,ci.city_name FROM camp c JOIN members m On m.member_id = c.member_id JOIN states s ON s.state_id = c.state_id JOIN city ci ON ci.city_id = c.city_id WHERE status = '1'");
