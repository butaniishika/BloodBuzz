...
<body>
    ...
    <div class="container">
        ...
        <h2>Pincode Wise Request Report</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="prequest.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="pinc_wise.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT m.pincode, m.name,b.blood_grp, r.* FROM members m JOIN requester r ON m.member_id = r.member_id JOIN blood_group b ON b.blood_id = r.blood_id
