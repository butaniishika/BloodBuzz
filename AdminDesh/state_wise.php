...
<body>
    ...
    <div class="container">
        ...
        <h2>State Wise Request Report</h2>
        <!-- Export Link -->
        <div>
        <form method="post" style="margin-left:1000px;">
            <button type="submit" class="btn btn-outline-danger" formaction="srequest.php"><i class="fa fa-file-pdf-o"></i> PDF</button>
            <button type="submit" class="btn btn-outline-success" formaction="stat_wise.php"><i class="fa fa-file-excel-o"></i> Excel</button>
        </form>
        </div><br>
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$connection->query("SELECT s.state_name, m.name, b.blood_grp,r.* FROM members m JOIN requester r ON m.member_id = r.member_id JOIN states s ON m.state = s.state_id JOIN blood_group b ON r.blood_id = b.blood_id
