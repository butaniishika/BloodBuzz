...
<body>
    ...
    <div class="container">
        ...
        <h2>Completed Request Record</h2>
        <!-- Export Link -->
        <div>
        ...
        <div class="row">
            <table class="table table-striped table-bordered">
                ...
                $result=$db->query("SELECT m.name, m.email, d.donor_member_id, d.created_at,d.certifide FROM members m
                JOIN deleted_request d ON m.member_id = d.member_id WHERE d.method = 'ourSite'");
