...
<head>
    <meta charset="utf-8">
    <title>Blood Buzz-Manage Camp</title>
    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu bg-transparent border-0">
                            ...
                            <a href="manageCamp.php" class="dropdown-item active">Camp</a>
                        </div>
                    </div>
                </div>
                </div>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                try
                {
                $get_members=$connection->prepare("SELECT c.city_name , s.state_name , ca.* FROM camp ca JOIN city c ON c.city_id = ca.city_id JOIN states s ON s.state_id = ca.state_id WHERE ca.status='1' LIMIT $offset,$records_per_page");
                $get_members->execute();
                ...
                $total_records = $connection->query("SELECT COUNT(*) FROM camp")->fetchColumn();
                ...
                <tr>
                        ...
                        <td>
                        <?php $encryptedCid=base64_encode($row['camp_id']); ?> 
                        <form action="deleteCamp.php?cid=<?php echo $encryptedCid; ?>" method="post">
